...
import {
  ...
  ToolsDrawerBody,
  VariablesDrawerBody,
} from "@/components/scenario-single-screen/config-drawers"
import {
  CriteriaIcon,
  ExtractionIcon,
  InsightsIcon,
...
import {
  ...
  OwnershipDrawerBody,
} from "@/components/scenario-single-screen/review-drawers"
import {
  RailGroup,
  SettingRow,
} from "@/components/scenario-single-screen/setting-rail"
import { SettingSheet } from "@/components/scenario-single-screen/setting-sheet"
import {
  DATA_EXTRACTION,
  DEFAULT_LANGUAGE,
  DESTINATIONS,
