...
function StepperTrigger({
  ...
  useEffect(() => {
    ...
    // Not [btnRef.current]: a ref never re-fires an effect, it only reads
    // during render. registerTrigger is the real dependency.
  }, [registerTrigger])

  // Our index among the triggers, for arrow-key navigation. Read on the
  // keystroke rather than memoised during render: it needs the ref, and a ref
  // read while rendering is both flagged and genuinely stale-prone.
  const indexOfSelf = () =>
